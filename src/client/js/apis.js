...
function execute(e) {
    ...
    .then(function(userData) {
        ...
        // if (placeName) {
            ...
            const apiData = postData('http://localhost:3000/add', {placeName: placeName, departureDate: departureDate, weather: weather.temp, summary: weather.weather, remainingDays: remainingDays});
            return apiData;
        }).then((apiData) => {
            updateUI(apiData);
        })
...
// //retrieve data from the app, inclduding picture from api, select necessary DOM elements, and update their values
 const updateUI = async (apiData) => {
    ...
    try{
        ...
        // const departureDate = document.getElementById('date').value;
        dateEntry.innerHTML = document.getElementById('date').value;
        ...
        cityEntry.innerHTML = apiData.placeName;
        ...
        daysLeftEntry.innerHTML = apiData.remainingDays;
        ...
        weatherEntry.innerHTML = apiData.temp;
        ...
        tempEntry.innerHTML = apiData.weather;
        weather.insertAdjacentElement('afterend', tempEntry);
